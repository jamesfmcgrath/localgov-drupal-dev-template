...
- A GitHub Actions CI workflow (`.github/workflows/ci.yml`) running PHPCS, PHPStan, PHPUnit (unit + kernel), the Prettier check, and a pa11y-ci accessibility job (WCAG2AA, against an installed sqlite site) on push and pull request.
